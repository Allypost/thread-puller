...
const DONATE = process.env.THREADPULLER_DONATE_LINK ? ` | <a href="${process.env.THREADPULLER_DONATE_LINK}" target="_blank" rel="noopener noreferrer">Donate if you like the sitedot</a>` : '';
